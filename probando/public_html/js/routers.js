...
app.config(['$stateProvider','$urlRouterProvider',function($stateProvider, $urlRouterProvider) {
        ...
        var link = [
            ...
            {name: 'Quienes Somos', url: '/Quienes Somos', templateUrl: 'views/menu/initiate/start.html', controller: "ItemController",as: "itemctrl",parent: "main"},
            ...
            {name: 'Normas internacionales', url: '/Normas internacionales', templateUrl: 'views/menu/accounting/internationalstandards.html', controller: "ItemController",as: "itemctrl",parent: "main"},
