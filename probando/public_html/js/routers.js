...
app.config(['$stateProvider','$urlRouterProvider',function($stateProvider, $urlRouterProvider) {
        ...
        var link = [
            ...
            {name: 'Tributaria', url: '/Tributaria', templateUrl: '<h3>Tributaria!</h3>', controller: "ItemController",as: "itemctrl",parent: "main"},
            {name: 'Auditoria y revisoria fiscal', url: '/Auditoria y revisoria fiscal', templateUrl: '<h3>Auditoria y revisoria fiscal!</h3>', controller: "ItemController",as: "itemctrl",parent: "main"},
